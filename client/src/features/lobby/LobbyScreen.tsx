    ...
    <ScreenContainer>
      <div className="fade-in">
        ...
        <Card>
          ...
          >
            <div className="text-xs uppercase tracking-widest mb-2" style={{ color: '#6b6b80' }}>Game Code</div>
            <div className="text-[36px] font-bold tracking-widest font-mono" style={{ color: '#e94560' }}>{match.id.toUpperCase()}</div>
          </div>

          <div className="mb-6">
            <div className="text-xs uppercase tracking-wider mb-3" style={{ color: '#6b6b80' }}>
